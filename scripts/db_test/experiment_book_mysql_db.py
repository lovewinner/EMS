...
def add_experiment_book_test():
    ...
    print "\n>>>>>>>>> The result of the function add_experiment_book() return : %s " % experiment.add_experiment_book(insert_param)

def get_experiments_book_test():
    experiment = ExperimentModel(settings.DB_CONFIGURE, settings.DB_CONN_RETRY)

    print "\n>>>>>>>>> The result of the function get_experiments_book() return : %s " % json.dumps(experiment.get_experiments_book(), indent=4)

def get_experiment_book_by_user_id_test():
    user_id_to_get = 2

    experiment = ExperimentModel(settings.DB_CONFIGURE, settings.DB_CONN_RETRY)
    print "\n>>>>>>>>> The result of the function get_experiment_book_by_user_id() return : %s " % json.dumps(experiment.get_experiment_book_by_user_id(user_id_to_get), indent=4)
...
def update_experiment_book_by_book_id_test():
    ...
    experiment = ExperimentModel(settings.DB_CONFIGURE, settings.DB_CONN_RETRY)
    print "\n>>>>>>>>> The result of the function update_experiment_book_by_book_id() return : %s " % experiment.update_experiment_book_by_book_id(book_id_to_update, update_param)

def delete_experiment_book_by_book_id_test():
    experiment_id_to_delete = 5

    experiment = ExperimentModel(settings.DB_CONFIGURE, settings.DB_CONN_RETRY)
    print "\n>>>>>>>>> The result of the function delete_experiment_book_by_book_id() return : %s " % experiment.delete_experiment_book_by_book_id(experiment_id_to_delete)
